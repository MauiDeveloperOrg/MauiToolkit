...
namespace MauiToolkit.Interop.Platforms.MacCatalyst.Helpers;
public static class RuntimeHelper
{
    public static NSObject? Alloc(string className)
    {
        var allocSelector = new Selector("alloc");
        var intPtr = RuntimeInterop.IntPtr_objc_msgSend(Class.GetHandle(className), allocSelector.Handle);
